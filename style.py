...
def apply_style():
    ...
    .kpi-value { font-size: 38px; font-weight: 950; color:#0f172a; line-height:1.05; margin:7px 0; }
    .kpi-sub { color:#64748b; font-size:13px; }
    .panel { background: white; border:1px solid #e2e8f0; border-radius: 22px; box-shadow: 0 14px 32px rgba(15,23,42,.07); padding: 22px; margin-bottom: 18px; }
    .panel-title { font-size: 20px; font-weight: 900; color:#0f172a; margin-bottom: 14px; }
    .quick-row { display:flex; justify-content:space-between; align-items:center; padding:12px; border-radius:14px; background:#f8fafc; border:1px solid #e2e8f0; margin-bottom:8px; }
    .count-pill { padding:4px 10px; border-radius:999px; font-weight:900; background:#dbeafe; color:#1d4ed8; }
    </style>
